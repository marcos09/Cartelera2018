...
INSERT INTO app_role (id, role_name, description) VALUES (3, 'PROFESOR_USER', 'Profesor User - Has permission to perform admin tasks');
INSERT INTO app_role (id, role_name, description) VALUES (4, 'PUBLICADOR_USER', 'Profesor User - Has permission to perform admin tasks');
